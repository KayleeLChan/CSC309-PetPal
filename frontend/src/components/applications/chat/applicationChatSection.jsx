...
function ApplicationChatSection(props) {
    const { commentsData, applicationID, onCommentSubmit, setQuery, query, totalPages} = props;
            ...
            <div data-bs-theme="petpal">
                    <div className="d-flex align-self-start mt-4 w-100 justify-content-left">
                        <div className="d-flex two-col-child w-90 m-4 px-5 py-5 bg-cream flex-column rounded">
                            <h2 className="mb-4 text-dark-brown text-decoration-underline responsive_heading">Your Chat:</h2>
                            <CommentBar objectID={applicationID} onCommentSubmit={onCommentSubmit} commentType='application'/>
...
export default ApplicationChatSection;