    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adopting_for', models.CharField(choices=[('myself', 'myself'), ('family', 'my family')], max_length=10)),
                ('children', models.CharField(choices=[('kids', 'kids'), ('none', 'no kids')], max_length=5)),
                ('pet_owner_history', models.CharField(choices=[('previous', 'previous'), ('first', 'first-time')], max_length=10)),
                ('current_pets', models.CharField(choices=[('none', 'no pet(s)'), ('cat', 'cat(s)'), ('dog', 'dog(s)'), ('both', 'dog(s) and cat(s)'), ('other', 'other pet(s)')], max_length=10)),
                ('ideal_pet', models.CharField(choices=[('none', 'none'), ('new', 'newborn'), ('young', 'young'), ('adult', 'adult'), ('senior', 'senior')], default='none', max_length=10)),
