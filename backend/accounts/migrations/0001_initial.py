    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pref_age', models.CharField(choices=[('none', 'none'), ('new', 'newborn'), ('young', 'young'), ('adult', 'adult'), ('senior', 'senior')], default='none', max_length=10)),
                ('pref_size', models.CharField(choices=[('none', 'no size preference'), ('S', 'small'), ('M', 'medium'), ('L', 'large'), ('XL', 'extra large')], default='none', max_length=5)),
                ('pref_colour', models.CharField(max_length=50)),
                ('pref_sex', models.CharField(choices=[('none', 'no gender preference'), ('F', 'female'), ('M', 'male')], default='none', max_length=5)),
                ('pref_personality', models.CharField(choices=[('none', 'no behaviour preference'), ('very active', 'very active'), ('active', 'active'), ('laid-back', 'laid-back'), ('lap', 'lap-pet')], default='none', max_length=15)),
            ],
            options={
                'verbose_name': 'user',
                'verbose_name_plural': 'users',
